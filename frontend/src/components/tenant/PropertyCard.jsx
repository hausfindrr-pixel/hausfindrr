    ...
    <Link to={`/property/${property.id}`} className="block group">
      ...
      <div className="relative rounded-2xl overflow-hidden mb-3" style={{ paddingBottom: '66%' }}>
        ...
        <button
          ...
          className="absolute top-2 right-2 bg-white/90 rounded-full flex items-center justify-center shadow-sm hover:bg-white hover:scale-110 transition-all duration-200 backdrop-blur-sm"
      ...
      {/* Info below photo — all text ≥ 14px (text-sm) */}
      <div>
        ...
        <div className="flex items-center justify-between mt-2 gap-2">
          ...
          {!property.unlocked && (
            <span className="flex items-center gap-1 text-sm text-gray-400 flex-shrink-0">
